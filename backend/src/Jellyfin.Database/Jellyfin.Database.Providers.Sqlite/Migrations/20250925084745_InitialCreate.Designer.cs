...
namespace Jellyfin.Database.Providers.Sqlite.Migrations
{
    ...
    [Migration("20250925084745_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jellyfin.Database.Implementations.Entities.PinBatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");

                    b.Property<int>("ActivePins")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<string>("CustomCharacterSet")
                        .HasMaxLength(255)
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int>("UsedPins")
                        .HasColumnType("INTEGER");

                    b.HasKey("Id");

                    b.ToTable("PinBatches");

                    b.HasAnnotation("Sqlite:UseSqlReturningClause", false);
                });

            modelBuilder.Entity("Jellyfin.Database.Implementations.Entities.PinBatchUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Jellyfin.Database.Implementations.Entities.PinBatchUser", b =>
                {
                    b.HasOne("Jellyfin.Database.Implementations.Entities.PinBatch", "Batch")
                        .WithMany("PinBatchUsers")
                        .HasForeignKey("BatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Jellyfin.Database.Implementations.Entities.User", "User")
                        .WithOne("PinBatchUser")
                        .HasForeignKey("Jellyfin.Database.Implementations.Entities.PinBatchUser", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
