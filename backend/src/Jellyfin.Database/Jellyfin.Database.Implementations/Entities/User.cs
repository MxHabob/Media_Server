...
{
    /// <summary>
    /// Enum to define subscription types for PIN-based access.
    /// </summary>
    ...
    public class User : IHasPermissions, IHasConcurrencyToken
    {
        ...
        public User(string username, string authenticationProviderId, string passwordResetProviderId)
        {
            ...
            SubscriptionType = SubscriptionType.None; // Default subscription type
            PinCode = null; // PIN not set by default
        ...
        /// <summary>
        /// Gets or sets the user's PIN code (hashed), or <c>null</c> if none is set.
        /// </summary>
        /// <remarks>
        /// Max length = 255 to accommodate hashed PIN (e.g., BCrypt output).
        /// </remarks>
        [MaxLength(255)]
        [StringLength(255)]
        ...
        /// <summary>
        /// Gets or sets the subscription type for the user.
        /// </summary>
        /// <remarks>
        /// Defines the access duration (e.g., 6 hours, weekly, lifetime).
        /// </remarks>
        public SubscriptionType SubscriptionType { get; set; }

        /// <summary>
        /// Gets or sets the expiration date for the user's access, or <c>null</c> for lifetime access.
        /// </summary>
