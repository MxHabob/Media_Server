...
public class UserController : BaseJellyfinApiController
{
    ...
    /// <summary>
    /// Generates a list of PINs for new users with the specified subscription type.
    /// </summary>
    ...
    [ProducesResponseType(StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status403Forbidden)]
    public async Task<ActionResult<List<string>>> GeneratePins([FromBody, Required] GeneratePinsRequest request)
    {
